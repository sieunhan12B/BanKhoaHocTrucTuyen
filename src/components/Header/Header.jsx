...
const Header = () => {
  ...
  return (
    <>
      <header
        className={`w-full z-50 transition-all fixed top-0  bg-white duration-300 ${
          isShrink ? "py-2 " : "py-3"
        }`}
      >
            ...
            <div className="fixed inset-0 bg-white z-50">
              <div className="flex flex-col h-full">
                ...
                <div className="flex justify-between items-center px-4 py-3 border-b">
                  <div className="w-24">
                    <Image width="100%" src="/Image/logo2.jpeg" preview={false} />
                  </div>
                  <button
      ...
      <div className={`h-${isShrink ? "16" : "24"}`}></div> {/* Spacer */}{" "}
    </>
  );
};
